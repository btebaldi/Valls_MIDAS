...
# Step: 1
accuracy_ar1_s1 <- c(rmse(inflation_cpi_test, ar1_f_avg_s1))
accuracy_ar2_s1 <- c(rmse(inflation_cpi_test, ar2_f_avg_s1))
accuracy_arima_s1 <- c(rmse(inflation_cpi_test, arima_f_avg_s1))
accuracy_arima_nl_s1 <- c(rmse(inflation_cpi_test, arima_nl_f_avg_s1[1:20]))
accuracy_var_1_s1 <- c(rmse(inflation_cpi_test, var_1_f_avg_s1))
accuracy_eqb_1_s1 <- c(rmse(inflation_cpi_test, eqb_1_f_avg_s1))
accuracy_eqdd_1_s1 <- c(rmse(inflation_cpi_test, eqdd_1_f_avg_s1))


loss_ar1_s1 <- LossLevel(inflation_cpi_test, ar1_f_avg_s1)
loss_ar2_s1 <- LossLevel(inflation_cpi_test, ar2_f_avg_s1)
loss_arima_s1 <- LossLevel(inflation_cpi_test, arima_f_avg_s1)
loss_arima_nl_s1 <- LossLevel(inflation_cpi_test, arima_nl_f_avg_s1[1:20])
loss_var_1_s1 <- LossLevel(inflation_cpi_test, var_1_f_avg_s1)
loss_eqb_1_s1 <- LossLevel(inflation_cpi_test, eqb_1_f_avg_s1)
loss_eqdd_1_s1 <- LossLevel(inflation_cpi_test, eqdd_1_f_avg_s1)


# Step: 2
accuracy_ar1_s2 <- c(rmse(inflation_cpi_test[-1], ar1_f_avg_s2))
accuracy_ar2_s2 <- c(rmse(inflation_cpi_test[-1], ar2_f_avg_s2))
accuracy_arima_s2 <- c(rmse(inflation_cpi_test[-1], arima_f_avg_s2))
accuracy_arima_nl_s2 <- c(rmse(inflation_cpi_test[-1], arima_nl_f_avg_s2))
accuracy_var_1_s2 <- c(rmse(inflation_cpi_test[-1], var_1_f_avg_s2))
accuracy_eqb_1_s2 <- c(rmse(inflation_cpi_test[-1], eqb_1_f_avg_s2))
accuracy_eqdd_1_s2 <- c(rmse(inflation_cpi_test[-1], eqdd_1_f_avg_s2))


loss_ar1_s2 <- LossLevel(inflation_cpi_test[-1], ar1_f_avg_s2)
loss_ar2_s2 <- LossLevel(inflation_cpi_test[-1], ar2_f_avg_s2)
loss_arima_s2 <- LossLevel(inflation_cpi_test[-1], arima_f_avg_s2)
loss_arima_nl_s2 <- LossLevel(inflation_cpi_test[-1], arima_nl_f_avg_s2)
loss_var_1_s2 <- LossLevel(inflation_cpi_test[-1], var_1_f_avg_s2)
loss_eqb_1_s2 <- LossLevel(inflation_cpi_test[-1], eqb_1_f_avg_s2)
loss_eqdd_1_s2 <- LossLevel(inflation_cpi_test[-1], eqdd_1_f_avg_s2)


# Step: 3
accuracy_ar1_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], ar1_f_avg_s3))
accuracy_ar2_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], ar2_f_avg_s3))
accuracy_arima_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], arima_f_avg_s3))
accuracy_arima_nl_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], arima_nl_f_avg_s3))
accuracy_var_1_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], var_1_f_avg_s3))
accuracy_eqb_1_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], eqb_1_f_avg_s3))
accuracy_eqdd_1_s3 <- c(rmse(inflation_cpi_test[-c(1:2)], eqdd_1_f_avg_s3))


loss_ar1_s3 <- LossLevel(inflation_cpi_test[-c(1:2)], ar1_f_avg_s3)
loss_ar2_s3 <- LossLevel(inflation_cpi_test[-c(1:2)], ar2_f_avg_s3)
loss_arima_s3 <- LossLevel(inflation_cpi_test[-c(1:2)], arima_f_avg_s3)
loss_arima_nl_s3 <- LossLevel(inflation_cpi_test[-c(1:2)], arima_nl_f_avg_s3)
loss_var_1_s3 <- LossLevel(inflation_cpi_test[-c(1:2)], var_1_f_avg_s3)
loss_eqb_1_s3 <- LossLevel(inflation_cpi_test[-c(1:2)], eqb_1_f_avg_s3)
...
for(step in 1:6){
  ...
  accuracy_in <- rbind(get(sprintf("accuracy_ar1_s%d", step)),
                       get(sprintf("accuracy_ar2_s%d", step)),
                       get(sprintf("accuracy_arima_s%d", step)), 
                       get(sprintf("accuracy_arima_nl_s%d", step)),
                       get(sprintf("accuracy_var_1_s%d", step)), 
                       get(sprintf("accuracy_eqb_1_s%d", step)),
                       get(sprintf("accuracy_eqdd_1_s%d", step)))
  ...
  # Tebaldi: Grava na memoria os resultados
  nome_da_var <- sprintf("accuracy_naive_h%d", step)
  cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
  assign(x = nome_da_var, value = accuracy_in)
...
for(step in 6:1){
  ...
  eqb_1_f_last <- matrix(get(sprintf("eqb_1_f_s%d", step)), 28)[28, ]
  
  accuracy_ar1 <- rmse(inflation_cpi_test[step:20], ar1_f_last)
  accuracy_arima <- rmse(inflation_cpi_test[step:20], arima_f_last)
  accuracy_var_1 <-rmse(inflation_cpi_test[step:20], var_1_f_last)
  accuracy_eqb_1 <- rmse(inflation_cpi_test[step:20], eqb_1_f_last)
  ...
  rownames(accuracy_in) <- c("AR(1)", "ARIMA", "VAR(1)", "Bridge Equation")  
  
  # Tebaldi: Grava na memoria os resultados
  nome_da_var <- sprintf("accuracy_naive_point_h%d", step)
  cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
  assign(x = nome_da_var, value = accuracy_in)
  ...
  for(step in 6:1){
    ...
    for (h in 0:(n_test - step)) {
      for (i in 1:28) {
        ...
        #-------- MIDAS-DL --------
        # tebaldi: informa o modelo que esta fazendo 
        # cat(sprintf("\nMIDAS-DL - y ~ trend + mls(z, step=%d, 1) + mls(x, 0:%d, 28)\n", step, l))
        ...
        nome_da_var <- sprintf("aux_eqm_u_rmse_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = aux_eqm_u_rmse)
        
        nome_da_var <- sprintf("eqm_u_f_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = eqm_u_f)
        
        
        #-------- MIDAS-AR(1) --------
        # tebaldi: informa o modelo que esta fazendo 
        # cat(sprintf("\nMIDAS-AR(1) - y ~ trend + mls(y, step=%d, 1) + mls(z, step=%d, 1) + mls(x, 0:%d, 28)\n", step, step, l))
        ...
        #%%%%% Tebaldi %%%% Comment: Codigo abaixo ainda é necessario???
        ...
        # Tebaldi: Grava na memoria os resultados
        # assign(paste("aux_eqm_u_rmse", step, sep = "_"), aux_eqm_ar1_rmse)
        nome_da_var <- sprintf("aux_eqm_ar1_rmse_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = aux_eqm_ar1_rmse)
        
        nome_da_var <- sprintf("eqm_ar1_f_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = eqm_ar1_f)
        
        
        
        #-------- MIDAS-AR(1)-R --------
        # tebaldi: informa o modelo que esta fazendo 
        # cat(sprintf("\nMIDAS-AR(1)-R - y ~ trend + mls(y, step=%d, 1) + mls(z, step=%d, 1) + mls(x, 0:%d, 28, nealmon)\n", step, step, l))
        ...
        # Tebaldi: Grava na memoria os resultados
        # assign(paste("aux_eqm_u_rmse", step, sep = "_"), aux_eqm_ar1_rmse)
        nome_da_var <- sprintf("aux_eqm_ar1r_rmse_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = aux_eqm_ar1r_rmse)
        
        nome_da_var <- sprintf("eqm_ar1r_f_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = eqm_ar1r_f)
        
        
        #-------- MIDAS-DL non-parametric--------
        
        # tebaldi: informa o modelo que esta fazendo 
        # cat(sprintf("\nMIDAS-DL non-parametric - y ~ trend + mls(x, 0:%d, 28)\n", l))
        ...
        # tebaldi: possivel erro de digitacao
        # aux_eqm_np_rmse <- rbind(aux_eqm_np_rmse, rmse(inflation_cpi_full_d[(((n_max-n_test)+step-1)*28+1):((TT+step-1)*28+i)], aux_eqm_np_f))
        aux_eqm_np_rmse <- rbind(aux_eqm_np_rmse, rmse(inflation_cpi_full_d[(((n_max-n_test)+step-1)*28+1):((TT+step-1)*28+i)], eqm_np_f))
        
        # Erro de COPY-PASTE (aux_eqm_np_rmse -> aux_eqm_np_rmse)
        # assign(paste("aux_eqm_np_rmse", step, sep = "_"), aux_eqm_ar1r_rmse)
        
        # Tebaldi: Grava na memoria os resultados
        # assign(paste("aux_eqm_u_rmse", step, sep = "_"), aux_eqm_ar1_rmse)
        nome_da_var <- sprintf("aux_eqm_np_rmse_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
        assign(x = nome_da_var, value = aux_eqm_np_rmse)
        
        nome_da_var <- sprintf("eqm_np_f_h%d_l%d", step, l)
        # cat(sprintf("\n\nGravando variavel (%s) com resultados\n", eqm_np_f))
        assign(x = nome_da_var, value = eqm_np_f)
        
      }
    }
  } # fim de step in 3:1
} # tebaldi: End of for(l in loop_list)

# tebaldi: valores de h1 com l6 l13 l27
...
# tebaldi: valores de h2 com l6 l13 l27
...
# tebaldi: valores de h3 com l6 l13 l27
...
eqm_u_f_h1_l6_avg <- colMeans(matrix(as.numeric(eqm_u_f_h1_l6), 28), na.rm = TRUE)
eqm_ar1_f_h1_l6_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h1_l6), 28), na.rm = TRUE)
eqm_ar1r_f_h1_l6_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h1_l6), 28), na.rm = TRUE)
eqm_np_f_h1_l6_avg <- colMeans(matrix(as.numeric(eqm_np_f_h1_l6), 28), na.rm = TRUE)

eqm_u_f_h2_l6_avg <- colMeans(matrix(as.numeric(eqm_u_f_h2_l6), 28), na.rm = TRUE)
eqm_ar1_f_h2_l6_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h2_l6), 28), na.rm = TRUE)
eqm_ar1r_f_h2_l6_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h2_l6), 28), na.rm = TRUE)
eqm_np_f_h2_l6_avg <- colMeans(matrix(as.numeric(eqm_np_f_h2_l6), 28), na.rm = TRUE)

eqm_u_f_h3_l6_avg <- colMeans(matrix(as.numeric(eqm_u_f_h3_l6), 28), na.rm = TRUE)
eqm_ar1_f_h3_l6_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h3_l6), 28), na.rm = TRUE)
eqm_ar1r_f_h3_l6_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h3_l6), 28), na.rm = TRUE)
...
eqm_np_f_h1_l13_avg <- colMeans(matrix(as.numeric(eqm_np_f_h1_l13), 28), na.rm = TRUE)

eqm_u_f_h2_l13_avg <- colMeans(matrix(as.numeric(eqm_u_f_h2_l13), 28), na.rm = TRUE)
eqm_ar1_f_h2_l13_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h2_l13), 28), na.rm = TRUE)
eqm_ar1r_f_h2_l13_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h2_l13), 28), na.rm = TRUE)
eqm_np_f_h2_l13_avg <- colMeans(matrix(as.numeric(eqm_np_f_h2_l13), 28), na.rm = TRUE)

eqm_u_f_h3_l13_avg <- colMeans(matrix(as.numeric(eqm_u_f_h3_l13), 28), na.rm = TRUE)
...
eqm_ar1_f_h1_l27_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h1_l27), 28), na.rm = TRUE)
eqm_ar1r_f_h1_l27_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h1_l27), 28), na.rm = TRUE)
eqm_np_f_h1_l27_avg <- colMeans(matrix(as.numeric(eqm_np_f_h1_l27), 28), na.rm = TRUE)

eqm_u_f_h2_l27_avg <- colMeans(matrix(as.numeric(eqm_u_f_h2_l27), 28), na.rm = TRUE)
eqm_ar1_f_h2_l27_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h2_l27), 28), na.rm = TRUE)
eqm_ar1r_f_h2_l27_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h2_l27), 28), na.rm = TRUE)
eqm_np_f_h2_l27_avg <- colMeans(matrix(as.numeric(eqm_np_f_h2_l27), 28), na.rm = TRUE)

eqm_u_f_h3_l27_avg <- colMeans(matrix(as.numeric(eqm_u_f_h3_l27), 28), na.rm = TRUE)
eqm_ar1_f_h3_l27_avg <- colMeans(matrix(as.numeric(eqm_ar1_f_h3_l27), 28), na.rm = TRUE)
eqm_ar1r_f_h3_l27_avg <- colMeans(matrix(as.numeric(eqm_ar1r_f_h3_l27), 28), na.rm = TRUE)
...
for(l in loop_list){
  for(step in 1:6){
    ...
    accuracy_eqm_ar1 <- rmse(inflation_cpi_full[(n_max- n_test + step):n_max], get(sprintf("eqm_ar1_f_h%d_l%d_avg", step, l)))
    loss_eqm_ar1 <- LossLevel(inflation_cpi_full[(n_max- n_test + step):n_max], get(sprintf("eqm_ar1_f_h%d_l%d_avg", step, l)))
    assign(sprintf("loss_eqm_ar1_h%d_l%d", step, l), loss_eqm_ar1)
    
    accuracy_eqm_ar1r <- rmse(inflation_cpi_full[( n_max- n_test + step):n_max], get(sprintf("eqm_ar1r_f_h%d_l%d_avg", step, l)))
    loss_eqm_ar1r <- LossLevel(inflation_cpi_full[( n_max- n_test + step):n_max], get(sprintf("eqm_ar1r_f_h%d_l%d_avg", step, l)))
    assign(sprintf("loss_eqm_ar1r_h%d_l%d", step, l), loss_eqm_ar1r)
    
    accuracy_eqm_np <- rmse(inflation_cpi_full[( n_max- n_test + step):n_max], get(sprintf("eqm_np_f_h%d_l%d_avg", step, l)))
    loss_eqm_np <- LossLevel(inflation_cpi_full[( n_max- n_test + step):n_max], get(sprintf("eqm_np_f_h%d_l%d_avg", step, l)))
    assign(sprintf("loss_eqm_np_h%d_l%d", step, l), loss_eqm_np)
    
    accuracy_in <- rbind(accuracy_eqm_u,
                         accuracy_eqm_ar1,
                         accuracy_eqm_ar1r,
                         accuracy_eqm_np)
    ...
    rownames(accuracy_in) <- c("MIDAS", "MIDAS-AR(1)", "MIDAS-AR(1)R", "MIDAS-NP")
    
    # Tebaldi: Grava na memoria os resultados
    nome_da_var <- sprintf("accuracy_midas_h%d_l%d", step, l)
    cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
    assign(x = nome_da_var, value = accuracy_in)
...
for(l in loop_list){
  for(step in 1:6){
    ...
    eqm_ar1r_f_last <- matrix(as.numeric(get(sprintf("eqm_ar1r_f_h%d_l%d", step, l))), 28)[28, ]
    eqm_np_f_last <- matrix(as.numeric(get(sprintf("eqm_np_f_h%d_l%d", step, l))), 28)[28, ][1:(n_test - step + 1)]
    ...
    accuracy_in <- rbind(accuracy_eqm_u, accuracy_eqm_ar1, accuracy_eqm_ar1r, accuracy_eqm_np)
    ...
    # Tebaldi: Grava na memoria os resultados
    nome_da_var <- sprintf("accuracy_midas_point_h%d_l%d", step, l)
    cat(sprintf("\n\nGravando variavel (%s) com resultados\n", nome_da_var))
    assign(x = nome_da_var, value = accuracy_in)
...
# tebaldi: Necessario converter em xts???
...
data = cbind(aux_var_1_rmse_1, aux_eqm_ar1_rmse_h1_l13, aux_eqm_ar1r_rmse_h1_l6)
...
data = cbind(aux_var_1_rmse_2, aux_eqm_ar1_rmse_h2_l13, aux_eqm_ar1r_rmse_h1_l6)
plot.zoo(data, plot.type = 'single', col = c(1,2,4), lwd=1, xlab='Period', ylab='RSMFE')
legend('bottomright', c('VAR (1)', 'MIDAS-ADL (l=13)', 'MIDAS-ADLr (l=6)'), lty = 1, col=c(1,2,4), nc=1, cex = 1, bty = "n")
title('h=2')

# data = cbind(aux_var_1_rmse_3, aux_eqm_ar1_rmse_3, aux_eqm_ar1r_rmse_3)
data = cbind(aux_var_1_rmse_3, aux_eqm_ar1_rmse_h3_l13, aux_eqm_ar1r_rmse_h3_l6)
plot.zoo(data, plot.type = 'single', col = c(1,2,4), lwd=1, xlab='Period', ylab='RSMFE')
...
# aux <- cbind(loss_ar1, loss_ar2, loss_arima, loss_arima_nl, loss_var_1,
#              loss_eqb_1, loss_eqm_u_6, loss_eqm_ar1_6, loss_eqm_ar1r_6, loss_eqm_np_6)
...
#%%%%%%%%%%%%%%%%%%
# tebaldi: 2022-10-12 - PAREI DE AJUSTAR NESTA LINHA
# O resto do script esta sem ajustar 
#%%%%%%%%%%%%%%%%%%
