...
rownames(accuracy_in) <- c("AR(1)", "AR(2)", "ARIMA(1,1,0)", "ARIMA(0,1,1)-LocalLevel", "VAR(1)", "Bridge-Equation", "Double-Difference",
                           "MIDAS-DL", "MIDAS-ADL", "MIDAS-ADLr",
                           "MIDAS-DLnp")

assign(paste("accuracy_in", l, sep = "_"),
       matrix(rbind(accuracy_ar1_in, accuracy_ar2_in, accuracy_arima_in, accuracy_arima_nl_in,  accuracy_var_1_in, accuracy_eqb_1_in,accuracy_eqdd_1_in,
                    accuracy_eqm_u_in, accuracy_eqm_ar1_in, accuracy_eqm_ar1r_in, accuracy_eqm_np_in), ncol = 1, nrow = 11,
              dimnames = list(c("AR(1)", "AR(2)","ARIMA(1,1,0)", "ARIMA(0,1,1)-LocalLevel", "VAR(1)", "Bridge Equation","Double Difference",
                                "MIDAS-DL", "MIDAS-ADL", "MIDAS-ADLr",
                                "MIDAS-DLnp"), c("RMSE"))
       )
)
...
ar2_f_avg <- colMeans(matrix(ar2_f, 28), na.rm = TRUE)
arima_f_avg <- colMeans(matrix(arima_f, 28), na.rm = TRUE)
arima_nl_f_avg <- colMeans(matrix(arima_nl_f, 28), na.rm = TRUE)
...
assign(paste("accuracy_naive", paste(step,l, sep="l"), sep = "_"),
       matrix(rbind(accuracy_ar1, accuracy_ar2, accuracy_arima, accuracy_arima_nl,accuracy_var_1, accuracy_eqb_1, accuracy_eqdd_1), ncol = 1, nrow = 7,
              dimnames = list(c("AR(1)","AR(2)","ARIMA(1,1,0)","ARIMA(0,1,1)-local_level", "VAR(1)", "Bridge Equation", "Double Difference"), c("RMSFE"))
       )
)
